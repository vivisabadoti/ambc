...
void setup() {
  ...
  void atualiza() // atualization of the cooking times on display
{
  u8g.setFont(u8g_font_robot_de_niro);
  u8g.drawLine(1, 0, 1, 64); u8g.drawLine(26, 0, 26, 64); u8g.drawLine(51, 0, 51, 64);u8g.drawLine(76, 0, 76, 64); u8g.drawLine(1, 7, 126, 7); //lines
  u8g.drawLine(101, 0, 101, 64); u8g.drawLine(126, 0, 126, 64); u8g.drawLine(151, 0, 151, 64); u8g.drawLine(101, 57, 126, 57);                 //lines
